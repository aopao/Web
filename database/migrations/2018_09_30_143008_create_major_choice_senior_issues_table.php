...
class CreateMajorChoiceSeniorIssuesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('major_choice_senior_issues', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('major_choice_senior_issues');
    }
}
