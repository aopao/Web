...
class CreateMajorChoiceSeniorReportsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('major_choice_senior_reports', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->text('subject_ratio')->comment('科目喜好比例');
    ...
    {
        Schema::dropIfExists('major_choice_senior_reports');
    }
}
