...
<div class="bgf">
	<div class="tem_div tem_div1">
		...
		<a target="_blank" href="http://apesk.com/mensa/common_report_getid//mbti1_report_hr_zy.asp?id={{ $private_data['apesk_id'] }}" class="start_a">生成报告</a>
	</div>
</div>

</body>
<script type="text/javascript">
    setTimeout("show_index()", 5000);
