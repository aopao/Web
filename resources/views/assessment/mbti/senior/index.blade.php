...
<div class="bg">
	...
	<form method="post" action="{{ route('assessment.mbti.senior.collect') }}" autocomplete="off">
		<div class="user">
			<div id="yonghu" style="">@lang('assessment/comment.professional')</div>
			<input id="textfield" maxlength="25" name="textfield" readonly="true" size="25" type="text" value="专业兴趣测试"/>
		</div>
		<div class="password">
