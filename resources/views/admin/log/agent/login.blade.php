		...
		<div class="layui-row layui-col-space15">
			<div class="layui-col-md12">
				<div class="layui-card">
					<div class="layui-card-header">@lang('admin/log.agent_login_list')</div>
					<div class="layui-card-body">
						<div class="table-action-button" style="margin-bottom: 10px;">
							<div class="layui-form" style="display:inline">
								<div class="layui-inline">
									<div class="layui-input-inline">
										<input type="text" name="agent" id="agent" value="" placeholder="@lang('admin/log.input_agent_id')" autocomplete="off" class="layui-input">
									</div>
								</div>
								<div class="layui-inline">
									<div class="layui-input-inline">
						...
						<table class="layui-hide" id="AgentLoginLogList" lay-filter="AgentLoginLogList"></table>
						<script type="text/html" id="AgentLoginLogListOperate">
...
@section('js')
	<script>
        let AgentLoginLogListUrl = '{{ route('log.agent.login.page') }}';
        ...
        layui.config({
            ...
            function render() {
                table.render({
                    elem: '#AgentLoginLogList'
                    , url: AgentLoginLogListUrl
                    , cellMinWidth: 80
                    , page: true
                    ...
                    , cols: [[
                        ...
                        , {field: 'agent_mobile', align: "center", title: '@lang('admin/log.admin_id')'}
            ...
            active = {
                Search: function () {
                    AgentLoginLogListUrl = '{{ route('log.agent.login.page') }}';
                    let agent = $('#agent').val()
                    let range_date = $('#range-date').val()
                    AgentLoginLogListUrl = AgentLoginLogListUrl + '?agent=' + agent + '&range_date=' + range_date;
                    render()
                }
            };
