			...
			<div class="layui-col-md12">
				<div class="layui-card">
					...
					<div class="layui-card-body" pad15="2">
						<form action="{{ route('admin.professional.category.store') }}" method="post" class="layui-form layui-form-pane">
							...
							<div class="layui-form-item">
								...
								<div class="layui-input-block">
									<input autocomplete="off" class="layui-input" lay-verify="required" name="professional_category_name" value="" placeholder="@lang('admin/professional.professional_category_name')" type="text"/>
								</div>
							</div>
							<div class="layui-form-item">
								<label class="layui-form-label">@lang('admin/professional.professional_category_code')</label>
								<div class="layui-input-block">
									<input autocomplete="off" class="layui-input" name="professional_category_code" value="" placeholder="@lang('admin/professional.professional_category_code')" type="text"/>
								</div>
							</div>
							<div class="layui-form-item">
								<label class="layui-form-label">@lang('admin/professional.professional_category_description')</label>
								<div class="layui-input-block">
									<input autocomplete="off" class="layui-input" name="description" value="" placeholder="@lang('admin/professional.professional_category_description')" type="text"/>
								</div>
							</div>
