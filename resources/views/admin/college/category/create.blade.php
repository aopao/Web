		...
		<div class="layui-row layui-col-space15">
			<div class="layui-col-md12">
				<div class="layui-card">
					<div class="layui-card-header">@lang('admin/college.college_category_add')</div>
					<div class="layui-card-body" pad15="2">
						<form action="{{ route('admin.college.category.store') }}" method="post" class="layui-form layui-form-pane">
