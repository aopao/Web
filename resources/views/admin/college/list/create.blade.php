		...
		<div class="layui-row layui-col-space15">
			<div class="layui-col-md12">
				<div class="layui-card">
					<div class="layui-card-header">@lang('admin/college.province_control_score_add')</div>
					<div class="layui-card-body" pad15="2">
						<form action="{{ route('admin.province.score.store') }}" method="post" class="layui-form layui-form-pane">
							<div class="layui-form-item" pane>
								<label class="layui-form-label">@lang('admin/college.subject')</label>
								<div class="layui-input-block">
									<input type="radio" name="subject" value="0" title="@lang('admin/college.subject_art')" checked="checked">
									<input type="radio" name="subject" value="1" title="@lang('admin/college.subject_math')">
								</div>
							</div>
							...
							<div class="layui-form-item">
								...
								<div class="layui-input-block">
									<input autocomplete="off" class="layui-input" lay-verify="required" name="batch" value="" placeholder="@lang('admin/college.batch')" type="text"/>
								</div>
							</div>
							<div class="layui-form-item">
								<label class="layui-form-label">@lang('admin/college.score')</label>
								<div class="layui-input-block">
									<input autocomplete="off" class="layui-input" lay-verify="required|number" name="score" value="" placeholder="@lang('admin/college.score')" type="text"/>
								</div>
							</div>
