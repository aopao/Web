			...
			<div class="layui-col-md12">
				<div class="layui-card">
					...
					<div class="layui-card-body" pad15="2">
						<form action="{{ route('admin.city.update',['id'=>$info['id']])  }}" method="post" class="layui-form layui-form-pane">
							...
							<div class="layui-form-item">
								...
								<div class="layui-input-block">
									<input autocomplete="off" class="layui-input" lay-verify="required" name="city_name" value="{{ $info['city_name'] }}" placeholder="@lang('comment/region.city_name')" type="text"/>
								</div>
							</div>
