...
myChart[3].resize;
Object.keys(myChart[4]).forEach(function(key){
	myChart[4][key].setOption(option[4][key]);
	myChart[4][key].resize;
});
myChart[5].setOption(option[5]);
myChart[5].resize;
myChart[6].setOption(option[6]);
myChart[6].resize;
myChart[7].setOption(option[7]);
myChart[7].resize;
myChart[8].setOption(option[8]);
myChart[8].resize;
myChart[9].setOption(option[9]);
myChart[9].resize;
myChart[10].setOption(option[10]);
myChart[10].resize;
myChart[11].setOption(option[11]);
myChart[11].resize;
myChart[14].setOption(option[14]);
myChart[14].resize;